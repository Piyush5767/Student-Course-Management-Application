System.register(["@angular/core", "../articles.service"], function (exports_1, context_1) {
    ...
    var core_1, articles_service_1, SelectedComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            SelectedComponent = /** @class */ (function () {
                function SelectedComponent(_articlesService) {
                    this._articlesService = _articlesService;
                }
                SelectedComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._articlesService.selected().subscribe(function (articles) { return _this.articles = articles; });
                };
            ...
            exports_1("SelectedComponent", SelectedComponent);
        }
    };
});
