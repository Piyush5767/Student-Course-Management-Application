    ...
    return {
        ...
        execute: function () {
            ArticlesService = /** @class */ (function () {
                ...
                ArticlesService.prototype.listUserCourse = function (articleId) {
                    return this._http
                        .post(this._baseURL + "/course/student/", { "articleId": articleId })
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                ArticlesService.prototype.append = function (article) {
                    return this._http
                        .post(this._baseURL + "/append/", article)
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                ArticlesService.prototype.exclude = function (article) {
                    return this._http
                        .post(this._baseURL + "/exclude/", article)
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                ArticlesService.prototype.selected = function () {
                    return this._http
                        .get(this._baseURL + '/selected')
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
