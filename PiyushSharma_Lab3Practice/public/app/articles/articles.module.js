System.register(["@angular/core", "@angular/common", "@angular/forms", "@angular/router", "./articles.routes", "./articles.component", "./create/create.component", "./list/list.component", "./view/view.component", "./edit/edit.component", "./append/append.component", "./selected/selected.component", "./exclude/exclude.component", "./studentcourse/list.component"], function (exports_1, context_1) {
    ...
    var core_1, common_1, forms_1, router_1, articles_routes_1, articles_component_1, create_component_1, list_component_1, view_component_1, edit_component_1, append_component_1, selected_component_1, exclude_component_1, list_component_2, ArticlesModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
                ...
                ArticlesModule = __decorate([
                    core_1.NgModule({
                        ...
                        declarations: [
                            ...
                            append_component_1.AppendComponent,
                            selected_component_1.SelectedComponent,
                            exclude_component_1.ExcludeComponent,
                            list_component_2.UserCourseListComponent
                        ]
                    })
                ], ArticlesModule);
